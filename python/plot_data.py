...
def plot_with_experimental_data() -> None:
    """Load and plot synthetic datasets alongside experimental data."""
    ...
    for i in range(1, NUM_DATASETS + 1):
        ...
        for col in REPLICATE_COLS:
            ax.plot(
                time_axis, df[col], color="gray", alpha=0.3, label="Synthetic Replicate"
            )
        ...
        ax.set_title(f"Synthetic Dataset {i} vs. AAV Experimental Data", fontsize=16)
