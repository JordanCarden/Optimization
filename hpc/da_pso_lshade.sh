...
#SBATCH --job-name=dual_annealing_pso_lshade
#SBATCH --output=logs/dual_annealing_pso_lshade_%j_out.txt
#SBATCH --error=logs/dual_annealing_pso_lshade_%j_err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=60
