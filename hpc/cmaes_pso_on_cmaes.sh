...
#SBATCH --job-name=cmaes_pso_on_cmaes
#SBATCH --output=logs/cmaes_pso_on_cmaes_%j_out.txt
#SBATCH --error=logs/cmaes_pso_on_cmaes_%j_err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=60
